...
hparams = HParams(
    ...
    # Mel spectrogram  
    n_fft=1288,  # Extra window size is filled with 0 paddings to match this parameter
    hop_size=322,  # For 16000Hz, 200 = 12.5 ms (0.0125 * sample_rate)
    win_size=1288,  # For 16000Hz, 800 = 50 ms (If None, win_size = n_fft) (0.05 * sample_rate)
    ...
    voc_upsample_factors = (7, 2, 23),    # NB - this needs to correctly factorise hop_length
    voc_rnn_dims = 512,
    voc_fc_dims = 512,
