...
from utils.MOSNet.model import CNN_BLSTM

from utils.MOSNet import utils   
import random
random.seed(1984) 
...
def main():
    ...
    parser.add_argument("--pretrained_model", default="./models/MOSNet/pre_trained/cnn_blstm.h5", type=str,
    ...
    # find waveform files
    wavfiles = sorted(find_files(args.rootdir, include_root_dir=True))
    print(wavfiles)
    # init model
